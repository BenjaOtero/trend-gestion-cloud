...
{
    public partial class frmActualizarFormasPago : Form
    {
        public frmActualizarFormasPago()
        {
            InitializeComponent();
        }
        ...
        private static OleDbDataAdapter AdaptadorSELECT()
        {
            ...
            OleDbCommand OleDbSelectCommand1 = new OleDbCommand("SELECT * FROM FormasPago", Connection1);
        ...
        public void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                dt.ReadXml(strFilePath + "FormasPago.xml");
                dt.AcceptChanges();
            }
            ...
            foreach (DataRowView rowAccess in viewAccess)
            {
                ...
                rowServer["IdFormaPagoFOR"] = rowAccess[0];
                rowServer["DescripcionFOR"] = rowAccess[1];
                rowServer.EndEdit();
            }
      //      BL.FormasPagoBLL.GrabarDB(dt);
