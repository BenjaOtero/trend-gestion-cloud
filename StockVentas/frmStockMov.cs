...
namespace StockVentas
{
    ...
    {
        private frmStockMov instanciaStockMov;
        ...
        public frmStockMov(DataSet dsStockMov)
        {
            InitializeComponent();
        ...
        public void cargarCombos()
        {
            ...
            viewDestino.RowFilter = "IdLocalLOC <>'1'";
        ...
        private void btnArticulos_Click(object sender, EventArgs e)
        {
            ...
            frmArticulos articulos = new frmArticulos(ref instanciaStockMov, tblArticulos);
            articulos.Show(this);
        ...
        private void grabar()
        {
            if (tblStockMovDetalle.GetChanges() != null)
            {
                ...
                rowView.EndEdit();
                progreso = new frmProgress(dsStockMov, "frmStockMov", "grabar", instanciaStockMov);
                progreso.Show();
        ...
        {
            DataGridViewTextBoxColumn ordenar = new DataGridViewTextBoxColumn();
            ordenar.Name = "ordenar";
            ordenar.DataPropertyName = "ordenar";
